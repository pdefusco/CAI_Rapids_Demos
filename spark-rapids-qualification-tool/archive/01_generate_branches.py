        ...
        branches = (
            ...
            .withColumn(
                ...
                CASE
                    ...
                    WHEN branch_id % 10 = 0 THEN 'Investment'

                    WHEN branch_id % 5 = 0 THEN 'Commercial'
...
def main():
    ...
    branches = generator.generateBranches(
