...
OUTPUT_TABLE = f"{DATABASE}.ETL_V9_RESULT_L4"
...
EVENT_LOG_DIR_LOCAL = "/home/cdsw/spark-rapids-qualification-tool/spark-event-logs-dir-l4"
os.makedirs(EVENT_LOG_DIR_LOCAL, exist_ok=True)

spark = (
    SparkSession.builder

    .appName("Spark-Rapids-ETL-v9.0-L4")
    ...
    .config("spark.executor.instances", "12")        # constrained to available CAI GPUs
    ...
    .config("spark.rapids.sql.concurrentGpuTasks", "3")
    ...
    .config("spark.rapids.memory.host.spillStorageSize", "4g")
